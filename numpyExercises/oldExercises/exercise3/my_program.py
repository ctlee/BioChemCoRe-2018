...
# Note: Don't think that you need to know absolutely all of the vague little commands in numpy in order to use it - I only know about these commands because I use them very frequently. Same with the pylab module that I use later in this example. I use both numpy and pylab extensively in my work but have probably used less than 10% of any of their functions. 
...
# EXERCISE: Properly label the Y-axis
